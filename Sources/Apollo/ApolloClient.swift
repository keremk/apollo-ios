...
public class ApolloClient {
  ...
  public func publisher<Query: GraphQLQuery>(query: Query, cachePolicy: CachePolicy = .returnCacheDataElseFetch, queue: DispatchQueue = DispatchQueue.main) -> AnyPublisher<GraphQLResult<Query.Data>?, Error> {
